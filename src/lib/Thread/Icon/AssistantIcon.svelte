<script lang="ts">
    ...
    import { showSettings, selectedAssistantId } from '../Assistant/Store.ts';
...
<div class="relative p-4 bg-white shadow rounded">
    <details class="w-full">
        ...
        <div class="p-2 text-blue-900 text-xs">Selected Assistant ID: 
        ...
        <!-- Image Uploader -->
        <div class="p-2 pl-4 text-blue-900">Image Uploader
            <Dropzone 
        ...
        <div class="mt-4 space-x-2 relative">
            <button class="btn-default" title="Upload New Image" on:click={() => { uploadIcon(files.accepted[0]); resetFiles(); } }>Upload New Image</button>
        </div>
    </details>
